        ...
        <ul class="navbar-nav">
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right mt-2" aria-labelledby="dropdownLanguage">
                    <a class="dropdown-item" href="#"><span class="flag-icon flag-icon-us mr-2"></span>อังกฤษ</a>
                    <a class="dropdown-item" href="#"><span class="flag-icon flag-icon-th mr-2"></span>ไทย<i
